	...
	<script type="text/javascript">
		$(function () {
			$("button.addCart").click(function () {
				...
				// 单击事件 更新ajax显示
				var bookId = $(this).attr("bookId");
				$.getJSON("http://localhost:8080//BookCityProject/CartServlet","action=ajaxAddItem&id="+bookId,function (data) {
	...
	<div id="header">
			...
			<div>
                <c:if test="${empty sessionScope.username}">
                    ...
                    <a href="UserServlet?action=registCode">注册</a> &nbsp;&nbsp;
                </c:if>
	...
	<div id="main">
		<div id="book">
			...
			<c:if test="${empty sessionScope.cart}">
				...
				<div><span style="color: red" id="cartLastName">购物车为空！</span></div>
			</c:if>
